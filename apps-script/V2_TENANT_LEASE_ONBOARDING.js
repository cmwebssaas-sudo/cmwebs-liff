        ...
        renewal_source:
          renewalSource
            ? {
                ...
                start_date: tenantLeaseFormatDate_(renewalSource.start_date || renewalSource.contract_start_date),
                end_date: tenantLeaseFormatDate_(renewalSource.end_date || renewalSource.contract_end_date),
...
function tenantLeaseUpsertLandlordTenantView_(
  ...
  if (
    ...
    throw new Error(
      'V2_landlord_tenant_list_view 的 Workspace canonical key 衝突'
    );
  }
...
function tenantLeaseUpsertTenantHomeView_(
  ...
  if (
    ...
    throw new Error(
      'V2_tenant_home_view 的 Workspace canonical key 衝突'
    );
  }
