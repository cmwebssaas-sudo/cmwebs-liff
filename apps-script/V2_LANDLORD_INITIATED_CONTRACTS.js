...
function landlordInitiatedContractNormalizeInput_(input) {
  ...
  const result = {
    ...
    initial_rent_paid_month: simpleFlow && landlordInitiatedContractBoolean_(input.initial_rent_paid) ? startDate.slice(0, 7) : '',
    initial_rent_paid_amount: simpleFlow && landlordInitiatedContractBoolean_(input.initial_rent_paid) ? landlordInitiatedContractNumber_(input.rent_amount) : 0,
  ...
  if (simpleFlow) result.management_fee_provided = landlordInitiatedContractText_(input.management_fee) !== '';
