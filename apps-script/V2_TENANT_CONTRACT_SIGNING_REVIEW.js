...
function tenantContractSigningReviewContractDocument_(contract) {
  ...
  const tenant = {
    tenant_id:
      tenantContractSigningReviewText_(contract.tenant_id),
    tenant_name:
      tenantContractSigningReviewText_(contract.tenant_name),
    phone:
      tenantContractSigningReviewText_(
        contract.tenant_phone || contract.phone
      ),
    address:
      tenantContractSigningReviewText_(
        contract.tenant_address || contract.address
      )
  };
