...
- [x] 續約表單起始日自動帶入原合約結束日，結束日自動計算為起始日加一年減一天；新租約流程與其他續約欄位不受影響（Phase 174／200；正式 Apps Script Version 144／GitHub Pages workflow `33553714995` 已發布並完成公開 readback，LINE 真機尚待驗證）
