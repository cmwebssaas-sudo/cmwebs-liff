...
- [x] 房東退房「快速結案」已正式部署：不要求電表讀數／照片，以手動應收金額與實際退款金額作為最終結算；另有本地候選修正退房專用 shell 的固定底部列遮罩問題，並保留 focus 自動捲動（Phase 252 runtime／Phase 253 UI／Phase 254 docs；正式部署於 PR #155／Apps Script Version 186／Pages workflow `34598441945`；遮罩修正為 Phase 255、本地候選尚未部署）
