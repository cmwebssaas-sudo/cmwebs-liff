...
- [x] **Step 1: Write the failing test for a new paper tenant.**
...
- [x] **Step 2: Add failing validation and idempotency cases.**
...
- [x] **Step 3: Add the existing-tenant and optional-ID cases.**
...
- [x] **Step 1: Add pure input normalization and validation.**
...
- [x] **Step 2: Add session route handling and Workspace access.**
...
- [x] **Step 3: Re-read canonical rows and reject conflicts inside the existing contract lock.**
...
- [x] **Step 4: Add the lock-aware private document writer.**
...
- [x] **Step 5: Create or reuse canonical tenant data and append the paper contract.**
...
- [x] **Step 6: Update room and view pointers after canonical rows exist.**
...
- [x] **Step 7: Run the focused test to reach GREEN.**
...
- [x] **Step 1: Write failing UI tests for both entrances and copy.**
...
- [x] **Step 2: Run the UI test to prove RED.**
...
- [x] **Step 3: Add the paper-backfill mode to the existing create page.**
...
- [x] **Step 4: Add file encoding and single-submit behavior.**
...
- [x] **Step 5: Add room and tenant-detail navigation.**
...
- [x] **Step 6: Run the UI test to reach GREEN.**
...
- [x] **Step 2: Run the documentation test to prove RED.**
...
- [x] **Step 3: Update API, test matrix, and current-state records.**
...
- [x] **Step 4: Run the documentation test to reach GREEN.**
...
- [x] **Step 1: Run focused runtime, UI, and docs tests together.**
...
- [x] **Step 2: Run full Node tests and project validation.**
  ...
  ```bash
  npm run validate
  node scripts/validate-project.js --root . --apps-dir apps-script --html-dir . --expected-routes 83
  ```
...
- [x] **Step 4: Review requirements against the spec.**
...
- [x] **Step 5: Commit the local candidate.**
