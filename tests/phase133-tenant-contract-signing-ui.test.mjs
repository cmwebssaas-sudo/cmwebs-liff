...
assert.match(source, /const API_URL\s*=\s*'https:\/\/script\.google\.com\/macros\/s\/AKfycbyrwKb3adOgHVBwbwHwLeSsDoUgYhaUaFXui66tnyMNBrT9eOVbi788oHeVRTif_LA9BA\/exec'/);
